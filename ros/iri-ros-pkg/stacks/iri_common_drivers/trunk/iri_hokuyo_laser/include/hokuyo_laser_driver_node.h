...
#ifndef _hokuyo_laser_driver_node_h_
#define _hokuyo_laser_driver_node_h_
 ...
 */
class HokuyoLaserDriverNode : public iri_base_driver::IriBaseNodeDriver<HokuyoLaserDriver>
{
  private:
  ...
  public:
    ...
    * \brief constructor
    *
    * This constructor mainly creates and initializes the HokuyoLaserDriverNode topics
    ...
    */
    HokuyoLaserDriverNode(ros::NodeHandle& nh);
