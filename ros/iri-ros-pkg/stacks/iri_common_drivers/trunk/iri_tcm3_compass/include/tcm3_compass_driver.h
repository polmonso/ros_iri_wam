...
#ifndef _tcm3_compass_driver_h_
#define _tcm3_compass_driver_h_

#include <iri_base_driver/iri_base_driver.h>
#include <iri_tcm3_compass/Tcm3CompassConfig.h>
#include <iri_common_drivers_msgs/compass3axis.h>

//include tcm3_compass_driver main library
#include "tcm3.h"
 ...
 * by IriBaseDriver.
 *
 * The Tcm3CompassDriver class must implement all specific driver requirements to
 ...
 *
 * The Tcm3CompassConfig.cfg needs to be filled up with those parameters suitable
 ...
 *
 */
class Tcm3CompassDriver : public iri_base_driver::IriBaseDriver
{
  private:
  ...
  public:
    ...
    *
    * Define a Config type with the Tcm3CompassConfig. All driver implementations
    ...
    */
    ...
    // here define all tcm3_compass_driver interface methods to retrieve and set
