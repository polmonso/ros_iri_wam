...
#ifndef _tcm3_compass_driver_node_h_
#define _tcm3_compass_driver_node_h_
 ...
 */
class Tcm3CompassDriverNode : public iri_base_driver::IriBaseNodeDriver<Tcm3CompassDriver>
{
  private:
  ...
  public:
    ...
    * \brief constructor
    *
    * This constructor mainly creates and initializes the Tcm3CompassDriverNode topics
