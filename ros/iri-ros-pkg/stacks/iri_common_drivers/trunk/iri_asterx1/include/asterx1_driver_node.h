...
#ifndef _asterx1_driver_node_h_
#define _asterx1_driver_node_h_

#include <iri_base_driver/iri_base_driver_node.h>
#include "asterx1_driver.h"

// [publisher subscriber headers]
#include "sensor_msgs/NavSatFix.h" //future ROS releases include this message at sensor_msgs package
 ...
 */
class Asterx1DriverNode : public iri_base_driver::IriBaseNodeDriver<Asterx1Driver>
{
  private:
    // [publisher attributes]
	ros::Publisher gpsStandard;
	sensor_msgs::NavSatFix gpsStandardMsg;
	
	//ros::Publisher gpsExtended;
	//iri_common_msgs::gpsExtended gpsExtendedMsg;
  ...
  public:
    ...
    * \brief constructor
    *
    * This constructor mainly creates and initializes the Asterx1DriverNode topics
    ...
    */
    Asterx1DriverNode(ros::NodeHandle& nh);
