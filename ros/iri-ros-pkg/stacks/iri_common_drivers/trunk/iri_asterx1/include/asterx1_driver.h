...
#ifndef _asterx1_driver_h_
#define _asterx1_driver_h_

#include <iri_base_driver/iri_base_driver.h>
#include <iri_asterx1/Asterx1Config.h>

//include asterx1_driver main library
 ...
 * by IriBaseDriver.
 *
 * The Asterx1Driver class must implement all specific driver requirements to
 ...
 *
 * The Asterx1Config.cfg needs to be filled up with those parameters suitable
 ...
 *
 */
class Asterx1Driver : public iri_base_driver::IriBaseDriver
{
  private:
  ...
  public:
    ...
    *
    * Define a Config type with the Asterx1Config. All driver implementations
    ...
    */
    ...
    // here define all asterx1_driver interface methods to retrieve and set
    ...
    */
	...
	///////////////////////////////////////////////////////////////////////
	/**
	* \brief set map origin
	*
	* Sets map origin and computes transformation matrix. 
	* This call is required if position/velocity data in terms of map coordinates is required.
	* Argument units are: Angles in degrees and altitude in meters.
	*/
	void setMapOrigin(double mapLat0, double mapLon0, double mapAlt0, double mapAlpha0); 
	
	/**
	* \brief Prints homogeneous transformation matrix
	*
	...
	*/
	...
	double getLat(bool units=inRADS); //by default return value in radians
	double getLon(bool units=inRADS); //by default return value in radians
	double getAlt();
	double getXWgs();
	double getYWgs();
	double getZWgs();
