...
#ifndef _leuze_laser_driver_node_h_
#define _leuze_laser_driver_node_h_
 ...
 */
class LeuzeLaserDriverNode : public iri_base_driver::IriBaseNodeDriver<LeuzeLaserDriver>
{
  private:
  ...
  public:
    ...
    * \brief constructor
    *
    * This constructor mainly creates and initializes the LeuzeLaserDriverNode topics
