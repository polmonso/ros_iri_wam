...
#ifndef _leuze_laser_driver_h_
#define _leuze_laser_driver_h_

#include <iri_base_driver/iri_base_driver.h>
#include <iri_leuze_laser/LeuzeLaserConfig.h>

//include leuze_laser_driver main library
 ...
 * by IriBaseDriver.
 *
 * The LeuzeLaserDriver class must implement all specific driver requirements to
 ...
 *
 * The LeuzeLaserConfig.cfg needs to be filled up with those parameters suitable
 ...
 *
 */
class LeuzeLaserDriver : public iri_base_driver::IriBaseDriver
{
  private:
  ...
  public:
    ...
    *
    * Define a Config type with the LeuzeLaserConfig. All driver implementations
    ...
    */
    ...
    // here define all leuze_laser_driver interface methods to retrieve and set
