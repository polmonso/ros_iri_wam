...
#ifndef _firewire_camera_driver_h_
 ...
 * by IriBaseDriver.
 *
 * The FirewireCameraDriver class must implement all specific driver requirements to
 ...
 *
 */
class FirewireCameraDriver : public iri_base_driver::IriBaseDriver
{
  private:
  ...
  public:
    ...
    */
    ...
    // here define all firewire_camera_driver interface methods to retrieve and set
