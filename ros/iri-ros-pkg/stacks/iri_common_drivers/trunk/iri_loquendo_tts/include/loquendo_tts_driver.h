...
#ifndef _loquendo_tts_driver_h_
#define _loquendo_tts_driver_h_

#include <iri_base_driver/iri_base_driver.h>
#include <iri_loquendo_tts/LoquendoTtsConfig.h>

//include loquendo_tts_driver main library
#include "loquendo_tts.h"
 ...
 * by IriBaseDriver.
 *
 * The LoquendoTtsDriver class must implement all specific driver requirements to
 ...
 *
 * The LoquendoTtsConfig.cfg needs to be filled up with those parameters suitable
 ...
 *
 */
class LoquendoTtsDriver : public iri_base_driver::IriBaseDriver
{
  private:
  ...
  public:
    ...
    *
    * Define a Config type with the LoquendoTtsConfig. All driver implementations
    ...
    */
    ...
    // here define all loquendo_tts_driver interface methods to retrieve and set
