...
#ifndef _loquendo_tts_driver_node_h_
#define _loquendo_tts_driver_node_h_
...
#include <iri_common_driver_msgs/ttsAction.h>
 ...
 */
class LoquendoTtsDriverNode : public iri_base_driver::IriBaseNodeDriver<LoquendoTtsDriver>
{
  private:
    ...
    IriActionServer<iri_common_driver_msgs::ttsAction> tts_aserver_;
    void startCallback(const iri_common_driver_msgs::ttsGoalConstPtr& goal);
    void stopCallback(void);
    bool isFinishedCallback(void);
    bool hasSucceedCallback(void);
    void getResultCallback(iri_common_driver_msgs::ttsResultPtr& result);
    void getFeedbackCallback(iri_common_driver_msgs::ttsFeedbackPtr& feedback);
  ...
  public:
    ...
    * \brief constructor
    *
    * This constructor mainly creates and initializes the LoquendoTtsDriverNode topics
