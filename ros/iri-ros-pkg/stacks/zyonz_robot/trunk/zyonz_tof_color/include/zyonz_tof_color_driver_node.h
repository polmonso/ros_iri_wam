...
#ifndef _zyonz_tof_color_driver_node_h_
#define _zyonz_tof_color_driver_node_h_
...
#include <Eigen/Core>
//#include <Eigen/Array> // Not required anymore
 ...
 */
class ZyonzTofColorDriverNode : public iri_base_driver::IriBaseNodeDriver<ZyonzTofColorDriver>
{
  private:
    ...
    */
    ...
    Matrix3f K_; ///RGB intrinsics
    Matrix4f P_; ///RGB_TOF extrinsics
    //MatrixXf Z_buffer_;
    int kernel_size_; // size of the kernel used to mask the Z_buffer to account for 
                      // the different image resolutions     
    /** @TODO: cal sincronitzar (amb timestamps?) les dues càmeres
    * De moment es fan servir aquests dos flags per comprovar que hi ha imatge disponible
    */
    bool depth_sent_;
    bool rgb_sent_;
    bool intens_sent_;
    ...
    */
    bool saveFile; //save the depth file
    int saveFileCounter;//save the depth file
  ...
  public:
    ...
    * \brief constructor
    *
    * This constructor mainly creates and initializes the ZyonzTofColorDriverNode topics
