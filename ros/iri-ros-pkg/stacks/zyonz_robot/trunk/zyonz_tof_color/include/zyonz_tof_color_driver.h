...
#ifndef _zyonz_tof_color_driver_h_
#define _zyonz_tof_color_driver_h_

#include <iri_base_driver/iri_base_driver.h>
#include <zyonz_tof_color/ZyonzTofColorConfig.h>

//include zyonz_tof_color_driver main library
 ...
 * by IriBaseDriver.
 *
 * The ZyonzTofColorDriver class must implement all specific driver requirements to
 ...
 *
 * The ZyonzTofColorConfig.cfg needs to be filled up with those parameters suitable
 ...
 *
 */
class ZyonzTofColorDriver : public iri_base_driver::IriBaseDriver
{
  private:
  ...
  public:
    ...
    *
    * Define a Config type with the ZyonzTofColorConfig. All driver implementations
    * will then use the same variable type Config.
    */
    typedef zyonz_tof_color::ZyonzTofColorConfig Config;
    ...
    */
    ...
    // here define all zyonz_tof_color_driver interface methods to retrieve and set
