...
#ifndef _pose2d_odom_alg_h_
#define _pose2d_odom_alg_h_
...
//include pose2d_odom_alg main library
 ...
 *
 */
class Pose2dOdomAlgorithm
{
  protected:
   /**
    * \brief define config type
    *
    * Define a Config type with the Pose2dOdomConfig. All driver implementations
  ...
  public:
    ...
    */
    ...
    // here define all pose2d_odom_alg interface methods to retrieve and set
