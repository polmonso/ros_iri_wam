...
#ifndef _compass_odom_alg_h_
#define _compass_odom_alg_h_

#include <iri_msg_to_odom/MessageToOdomConfig.h>
#include "mutex.h"

//include compass_odom_alg main library
 ...
 *
 */
class CompassOdomAlgorithm
{
  protected:
   /**
    * \brief define config type
    *
    * Define a Config type with the CompassOdomConfig. All driver implementations
  ...
  public:
    ...
    */
    ...
    // here define all compass_odom_alg interface methods to retrieve and set
