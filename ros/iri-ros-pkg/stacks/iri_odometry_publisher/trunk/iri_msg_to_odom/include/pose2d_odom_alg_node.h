...
#ifndef _pose2d_odom_alg_node_h_
#define _pose2d_odom_alg_node_h_
 ...
 *
 */
class Pose2dOdomAlgNode : public algorithm_base::IriBaseAlgorithm<Pose2dOdomAlgorithm>
{
  private:
    ...
    std::string   P2D_IN;  //!< unique name of the event
