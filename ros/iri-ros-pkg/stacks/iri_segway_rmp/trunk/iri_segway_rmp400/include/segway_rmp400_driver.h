...
#ifndef _segway_rmp400_driver_h_
#define _segway_rmp400_driver_h_
...
//include segway_rmp400_driver main library
 ...
 * by IriBaseDriver.
 *
 * The SegwayRmp400Driver class must implement all specific driver requirements to
 ...
 *
 * The SegwayRmp400Config.cfg needs to be filled up with those parameters suitable
 ...
 *
 */
class SegwayRmp400Driver : public iri_base_driver::IriBaseDriver
{
  private:
  ...
  public:
    ...
    *
    * Define a Config type with the SegwayRmp400Config. All driver implementations
    ...
    */
    ...
    /**
     * \brief return ROS message status from the platform
     *
     * This function transforms what is get by the low level driver to the
     * ROS message format. Includes all kind of low level info.
     */
    iri_segway_rmp_msgs::SegwayRMP400Status get_status(void);

    // here define all segway_rmp400_driver interface methods to retrieve and set
