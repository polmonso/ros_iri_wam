...
#ifndef _segway_rmp400_driver_node_h_
#define _segway_rmp400_driver_node_h_
 ...
 */
class SegwayRmp400DriverNode : public iri_base_driver::IriBaseNodeDriver<SegwayRmp400Driver>
{
  private:
      ros::Publisher status_publisher_;
      ros::Subscriber cmd_vel_subscriber_;
      tf::TransformBroadcaster tf_broadcaster_;
      iri_segway_rmp_msgs::SegwayRMP400Status segway_status_msg_;
  ...
  public:
    ...
    * \brief constructor
    *
    * This constructor mainly creates and initializes the SegwayRmp400DriverNode topics
    ...
    */
    SegwayRmp400DriverNode(ros::NodeHandle& nh);
