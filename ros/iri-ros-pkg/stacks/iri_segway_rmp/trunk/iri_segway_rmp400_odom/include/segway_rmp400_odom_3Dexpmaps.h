...
#ifndef _segway_rmp400_odom_h_
#define _segway_rmp400_odom_h_
    ...
    public odometry_core::IriBaseOdometry<iri_segway_rmp_msgs::SegwayRMP400Status>
{
  ...
  protected:
    ...
    */
    geometry_msgs::Transform accum;
    Eigen::Matrix4f H;
    double dt;
    double vyaw;
    double vpitch;
    double vroll;
    double v_left_wheels;
    double v_right_wheels;
    double vT;
    double roll_;
    double pitch_;
    double yaw_;
    ...
    Eigen::Matrix3f I;
    Eigen::Vector3f t;
    Eigen::Vector3f ta, tb;
    Eigen::Matrix4f g;
    Eigen::Vector4f d;
    Eigen::Vector4f q;  // quaternion vector in q(0)-q(2), scalar part in q(3)
    int i;
