...
#ifndef _segway_rmp200_driver_node_h_
#define _segway_rmp200_driver_node_h_
 ...
 */
class SegwayRmp200DriverNode : public iri_base_driver::IriBaseNodeDriver<SegwayRmp200Driver>
{
  private:
    // [publisher attributes]
    ros::Publisher status_publisher_;
    iri_segway_rmp_msgs::SegwayRMP200Status segway_status_msg_;
    void updateSegwayStatus();

    // [subscriber attributes]
    ros::Subscriber cmd_platform_subscriber_;
  ...
  public:
    ...
    * \brief constructor
    *
    * This constructor mainly creates and initializes the SegwayRmp200DriverNode topics
    ...
    */
    SegwayRmp200DriverNode(ros::NodeHandle& nh);
  ...
  protected:
    ...
    */
    ...
    void ui_battery_check(diagnostic_updater::DiagnosticStatusWrapper &stat);
    void pb_battery_check(diagnostic_updater::DiagnosticStatusWrapper &stat);
