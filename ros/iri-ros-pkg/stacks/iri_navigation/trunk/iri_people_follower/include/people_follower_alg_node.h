...
class PeopleFollowerAlgNode : public algorithm_base::IriBaseAlgorithm<PeopleFollowerAlgorithm>
{
  private:
    ...
    std::string target_found_event_id_;
    std::string followT_done_event_id_;

    typedef enum {IDLE_STATE, REQ_MB_STATE, SUCCESS_STATE, UPDATE_STATE, PREEMPT_STATE} states;
