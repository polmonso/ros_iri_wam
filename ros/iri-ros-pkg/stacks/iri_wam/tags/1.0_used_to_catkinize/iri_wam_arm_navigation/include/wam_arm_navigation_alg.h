...
#ifndef _wam_arm_navigation_alg_h_
#define _wam_arm_navigation_alg_h_
...
//include wam_arm_navigation_alg main library
 ...
 *
 */
class WamArmNavigationAlgorithm
{
  protected:
   /**
    * \brief define config type
    *
    * Define a Config type with the WamArmNavigationConfig. All driver implementations
  ...
  public:
    ...
    */
    ...
    // here define all wam_arm_navigation_alg interface methods to retrieve and set
