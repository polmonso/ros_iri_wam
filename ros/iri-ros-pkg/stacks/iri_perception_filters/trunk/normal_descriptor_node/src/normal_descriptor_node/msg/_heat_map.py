"""autogenerated by genmsg_py from heat_map.msg. Do not edit."""
import roslib.message
import struct

import geometry_msgs.msg

class heat_map(roslib.message.Message):
  _md5sum = "f7fc61d678f26d3b0e188f96f882251f"
  _type = "normal_descriptor_node/heat_map"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """float32[] data
geometry_msgs/Vector3[] points3d
int32 width
int32 height
================================================================================
...
float64 z
"""
  __slots__ = ['data','points3d','width','height']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(heat_map, self).__init__(*args, **kwds)
