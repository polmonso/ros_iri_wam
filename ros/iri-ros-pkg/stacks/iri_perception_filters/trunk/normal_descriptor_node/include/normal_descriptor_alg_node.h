...
class NormalDescriptorAlgNode : public algorithm_base::IriBaseAlgorithm<NormalDescriptorAlgorithm>
{
  private:
    ...
    ros::Publisher heatmap_publisher_;
    ros::Publisher heatmap_pointcloud_publisher_;

    // [subscriber attributes]
    ros::Subscriber points_subscriber_;
    void points_callback(const sensor_msgs::PointCloud2::ConstPtr& msg);
    normal_descriptor_node::heat_map compute_wrinkle_map(pcl::PointCloud<pcl::PointXYZRGB> &cloud);

    // [service attributes]
    ros::ServiceServer wrinkle_map_service_;
    bool wrinkle_map_service_callback(normal_descriptor_node::wrinkle::Request &req, normal_descriptor_node::wrinkle::Response &res);
