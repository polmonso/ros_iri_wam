...
#ifndef _tibi_dabo_head_driver_node_h_
#define _tibi_dabo_head_driver_node_h_
 ...
 */
class TibiDaboHeadDriverNode : public iri_base_driver::IriBaseNodeDriver<TibiDaboHeadDriver>
{
  private:
    ...
    ros::Subscriber facial_expression_subscriber_;
    void facial_expression_callback(const std_msgs::String::ConstPtr& msg);
    CMutex facial_expression_mutex_;
    ...
    // Action server fo the motion sequences
    IriActionServer<tibi_dabo_msgs::sequenceAction> motion_sequence_aserver_;
    ...
    // action server for the facial expression sequences
    IriActionServer<tibi_dabo_msgs::sequenceAction> lights_sequence_aserver_;
    void lights_sequence_startCallback(const tibi_dabo_msgs::sequenceGoalConstPtr& goal);
    void lights_sequence_stopCallback(void);
    bool lights_sequence_isFinishedCallback(void);
    bool lights_sequence_hasSucceedCallback(void);
    void lights_sequence_getResultCallback(tibi_dabo_msgs::sequenceResultPtr& result);
    void lights_sequence_getFeedbackCallback(tibi_dabo_msgs::sequenceFeedbackPtr& feedback);
 
    // action server for the joint motion of the head
  ...
  public:
    ...
    * \brief constructor
    *
    * This constructor mainly creates and initializes the TibiDaboHeadDriverNode topics
    ...
    */
    TibiDaboHeadDriverNode(ros::NodeHandle& nh);
  ...
  protected:
    ...
    */
    ...
    void check_lights_sequence_status(diagnostic_updater::DiagnosticStatusWrapper &stat);
