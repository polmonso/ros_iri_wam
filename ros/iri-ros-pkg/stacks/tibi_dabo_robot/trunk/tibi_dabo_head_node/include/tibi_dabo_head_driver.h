...
#ifndef _tibi_dabo_head_driver_h_
#define _tibi_dabo_head_driver_h_

#include <iri_base_driver/iri_base_driver.h>
#include <tibi_dabo_head_node/TibiDaboHeadConfig.h>

//include tibi_dabo_head_driver main library
#include "segway_head.h"
#include "motion_sequence.h"
#include "segway_lights_sequence.h"

extern std::string config_path;
extern std::string motion_path;
extern std::string lights_path;
 ...
 * by IriBaseDriver.
 *
 * The TibiDaboHeadDriver class must implement all specific driver requirements to
 ...
 *
 * The TibiDaboHeadConfig.cfg needs to be filled up with those parameters suitable
...
//    float brightness;
  ...
  public:
    ...
    *
    * Define a Config type with the TibiDaboHeadConfig. All driver implementations
    ...
    */
    ...
    // here define all tibi_dabo_head_driver interface methods to retrieve and set
    ...
    // API for the light sequences
    /**
     * \brief 
     *
     */
    void start_lights_sequence(std::string &filename);
    /**
     * \brief 
     *
     */
    void pause_lights_sequence(void);
    /**
     * \brief 
     *
     */
    void resume_lights_sequence(void);
    /**
     * \brief 
     *
     */
    void stop_lights_sequence(void);
    /**
     * \brief 
     *
     */
    std::string get_lights_sequence_complete_event_id(void);
    /**
     * \brief 
     *
     */
    float get_lights_sequence_completed_percentage(void);
     ...
     *
     */
    unsigned int get_num_lights_seq_files(void);
    /**
     * \brief 
     *
     */
    std::string get_lights_seq_file(unsigned int index); 
    /**
     * \brief 
     *
     */
