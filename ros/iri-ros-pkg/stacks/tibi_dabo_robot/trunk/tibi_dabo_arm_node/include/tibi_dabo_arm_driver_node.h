...
#ifndef _tibi_dabo_arm_driver_node_h_
#define _tibi_dabo_arm_driver_node_h_
 ...
 */
class TibiDaboArmDriverNode : public iri_base_driver::IriBaseNodeDriver<TibiDaboArmDriver>
{
  private:
  ...
  public:
    ...
    * \brief constructor
    *
    * This constructor mainly creates and initializes the TibiDaboArmDriverNode topics
